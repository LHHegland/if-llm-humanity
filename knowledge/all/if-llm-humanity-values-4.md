...
- **Purpose:** Define five canonical human values — Justice, Fairness, Citizenship, Leadership, and Persistence — as structured IF-LLM knowledge entries. Each entry provides definitions, hierarchical relationships, symbolic and literary elements, ontological connections, IF/THEN retrieval rules, scope boundaries, and application examples to support reasoning, explanation, narrative generation, and value-based decision support for diverse US audiences.
- **Audience:** Average, diverse people in the United States of America today.
- **Features**
  - Five fully structured value entries (Justice, Fairness, Citizenship, Leadership, Persistence) with canonical IDs and namespace tags
...
- **Scope**
  - **Covers:** Definitions, symbolic elements, literary elements, ontological relationships, retrieval rules, scope boundaries, and application examples for Justice, Fairness, Citizenship, Leadership, and Persistence; cross-references to sibling values files (1–3, 5) and to `if-llm-humanity.md`, `if-llm-humanity-narm.md`, and `if-llm-humanity-fallibility.md`
  - **Out of Scope:** Values covered in sibling files (`if-llm-humanity-values-1.md` through `if-llm-humanity-values-3.md` and `if-llm-humanity-values-5.md`); OODA processing constructs (`if-llm-humanity-ooda.md`); NARM needs/resources/activities constructs (`if-llm-humanity-narm.md`); legal compliance analysis; clinical or psychological definitions; political party platforms or immigration policy
- **Use Cases**
...
- **Known Gaps / Limitations**
  ...
  - Literary elements emphasize Western and broadly cross-cultural sources; coverage of Indigenous North American, African, South Asian, and East Asian traditions is present but uneven across entries.
...
- **Changelog**
  ...
  - 2026-06-22 23:13 UTC by Claude (Anthropic) on behalf of [Lance Hegland](lance.hegland@gmail.com): Comprehensive structural enhancement of all five entries and file header. Specifically:
    ...
    - **Concept Disambiguation:** Populated previously TBD section with seven disambiguation notes distinguishing: Justice vs. Fairness; Justice vs. Compassion; Fairness vs. Mercy; Citizenship vs. Leadership; Leadership vs. Prudence; Persistence vs. Courage; and Persistence vs. Hope.
    - **All five entries (Justice, Fairness, Citizenship, Leadership, Persistence):** Added IF-LLM Application Example; Ontological Relationships (Related to, Requires, Required by, Affects, Vulnerable to); IF/THEN Decision Rules; and Scope/Exclusion Boundaries.
...
- **IF-LLM Application Example:** When explaining why laws and courts matter for protecting vulnerable communities, an IF-LLM draws on [[HUMANITY:JUSTICE]] to frame institutional accountability, rule of law, and the systemic structures that uphold equal rights. When comparing how two different communities are treated by a shared institution, an IF-LLM uses [[HUMANITY:JUSTICE]] to assess whether outcomes reflect structural equity or structural harm.

- **Ontological Relationships**
  - **Related to:** [[HUMANITY:FAIRNESS]], [[HUMANITY:COMPASSION]] (`if-llm-humanity-values-2.md`), [[HUMANITY:INTERDEPENDENCE]] (`if-llm-humanity-values-1.md`), [[HUMANITY:RIGHTS]] (`if-llm-humanity.md`), [[HUMANITY:INTEGRITY]] (`if-llm-humanity-values-5.md`)
  - **Requires:** [[HUMANITY:FAIRNESS]] (as the operational standard within just systems), [[HUMANITY:CITIZENSHIP]] (sustained civic participation maintains just institutions), [[HUMANITY:LEADERSHIP]] (ethical leaders implement and uphold just systems)
  - **Required by:** Civic order, democratic governance, human dignity frameworks
  - **Affects:** [[HUMANITY:CITIZENSHIP]] (just institutions shape civic engagement), [[HUMANITY:LEADERSHIP]] (just norms constrain and guide leaders), [[HUMANITY:PERSISTENCE]] (achieving justice frequently requires sustained effort), [[HUMANITY:VISION]] and [[HUMANITY:MISSION]] (`if-llm-humanity.md`)
  - **Vulnerable to:** [[HUMANITY:TEMPTATIONS]] — especially power abuse, favoritism, and self-interest (`if-llm-humanity-fallibility.md`); [[HUMANITY:PREJUDICES]] and [[HUMANITY:DISCRIMINATION]] (`if-llm-humanity-fallibility.md`); institutional capture and corruption

- **IF/THEN Decision Rules**
  - IF the topic involves courts, laws, governance, or systemic accountability → THEN cite [[HUMANITY:JUSTICE]] (not [[HUMANITY:FAIRNESS]]).
  - IF the topic involves whether a specific decision or interaction treated a person equitably → THEN cite [[HUMANITY:FAIRNESS]] (not [[HUMANITY:JUSTICE]]).
  - IF the output requires a moral critique of a power structure or institution → THEN include [[HUMANITY:JUSTICE]] and cross-reference [[HUMANITY:RIGHTS]] (`if-llm-humanity.md`).
  - IF the output addresses justice in a context involving emotional suffering → THEN include [[HUMANITY:COMPASSION]] (`if-llm-humanity-values-2.md`) alongside [[HUMANITY:JUSTICE]].
  - IF addressing historical injustice or structural inequality → THEN cross-reference [[HUMANITY:DISCRIMINATION]] and [[HUMANITY:PREJUDICES]] (`if-llm-humanity-fallibility.md`).

- **Scope / Exclusion Boundaries**
  - **Covers:** Systemic fairness; legal and institutional accountability; rights-based frameworks; civic order; accountability for wrongdoing; structural equity analysis
  - **Excludes:** Interpersonal conflict resolution centered on emotional healing (see [[HUMANITY:COMPASSION]]); legal advice or compliance determinations; psychological definitions of justice (e.g., restorative justice therapy); political party platforms or partisan policy advocacy
...
- **IF-LLM Application Example:** When evaluating whether a workplace policy, school rule, or community practice treats all people equitably, an IF-LLM draws on [[HUMANITY:FAIRNESS]] to assess impartiality, consistent rule application, and freedom from favoritism in that specific context. When helping someone understand the difference between equality (same treatment) and equity (treatment proportional to need), an IF-LLM applies [[HUMANITY:FAIRNESS]] to explain why equitable outcomes may require different inputs.

- **Ontological Relationships**
  - **Related to:** [[HUMANITY:JUSTICE]], [[HUMANITY:COMPASSION]] (`if-llm-humanity-values-2.md`), [[HUMANITY:HUMILITY]] (`if-llm-humanity-values-2.md`), [[HUMANITY:TEMPERANCE]] (`if-llm-humanity-values-2.md`), [[HUMANITY:THINKING]] (`if-llm-humanity-values-1.md`)
  - **Requires:** [[HUMANITY:HUMILITY]] (recognition of one's own potential bias), [[HUMANITY:THINKING]] (impartial reasoning to apply consistent standards), [[HUMANITY:WISDOM]] (`if-llm-humanity-values-1.md`) (judgment to distinguish equity from equality)
  - **Required by:** [[HUMANITY:JUSTICE]] (Fairness is the operational standard within just systems); [[HUMANITY:LEADERSHIP]] (leaders must apply fair standards to maintain legitimacy); [[HUMANITY:CITIZENSHIP]] (civic trust depends on fair treatment)
  - **Affects:** [[HUMANITY:CITIZENSHIP]] (fair processes sustain civic participation), [[HUMANITY:LEADERSHIP]] (leaders are judged by their fairness), [[HUMANITY:INTERDEPENDENCE]] (`if-llm-humanity-values-1.md`) (fair treatment reinforces trust across communities)
  - **Vulnerable to:** [[HUMANITY:PREJUDICES]] and [[HUMANITY:STEREOTYPES]] (`if-llm-humanity-fallibility.md`) — implicit bias distorts impartial judgment; [[HUMANITY:TEMPTATIONS]] — especially favoritism and self-interest (`if-llm-humanity-fallibility.md`); [[HUMANITY:DISCRIMINATION]] (`if-llm-humanity-fallibility.md`)

- **IF/THEN Decision Rules**
  - IF the topic involves whether a specific individual decision or interaction is impartial and equitable → THEN cite [[HUMANITY:FAIRNESS]].
  - IF the topic involves the design or accountability of institutions, laws, or governance systems → THEN cite [[HUMANITY:JUSTICE]] (not [[HUMANITY:FAIRNESS]]).
  - IF comparing treatment across demographic groups → THEN cross-reference [[HUMANITY:FAIRNESS]] with [[HUMANITY:DISCRIMINATION]] and [[HUMANITY:PREJUDICES]] (`if-llm-humanity-fallibility.md`).
  - IF the output involves deliberate leniency or exception-making out of compassion → THEN cite [[HUMANITY:MERCY]] (`if-llm-humanity-values-2.md`), not [[HUMANITY:FAIRNESS]].
  - IF the task requires distinguishing equality from equity → THEN apply [[HUMANITY:FAIRNESS]] and note that equitable outcomes may require unequal inputs.

- **Scope / Exclusion Boundaries**
  - **Covers:** Impartiality in individual decisions and interactions; equal opportunity; procedural equity; non-discrimination in specific contexts; consistent rule application
  - **Excludes:** Systemic legal accountability and institutional design (see [[HUMANITY:JUSTICE]]); deliberate compassionate exception-making (see [[HUMANITY:MERCY]]); legal advice or compliance determinations; clinical or legal definitions of "fairness" in adjudicative contexts
...
- **IF-LLM Application Example:** When helping someone understand how ordinary people can make a meaningful difference in their neighborhood, school, or community, an IF-LLM draws on [[HUMANITY:CITIZENSHIP]] to describe civic participation, shared responsibility, and the mutual obligations that bind communities together. When explaining why voter turnout, volunteerism, or showing up to local meetings matters, an IF-LLM applies [[HUMANITY:CITIZENSHIP]] to connect individual actions to the health of shared institutions.

- **Ontological Relationships**
  - **Related to:** [[HUMANITY:JUSTICE]], [[HUMANITY:LEADERSHIP]], [[HUMANITY:INTERDEPENDENCE]] (`if-llm-humanity-values-1.md`), [[HUMANITY:RIGHTS]] (`if-llm-humanity.md`), [[HUMANITY:FAIRNESS]], [[HUMANITY:INTEGRITY]] (`if-llm-humanity-values-5.md`)
  - **Requires:** [[HUMANITY:FAIRNESS]] (citizens depend on equitable treatment to trust institutions), [[HUMANITY:WISDOM]] (`if-llm-humanity-values-1.md`) (informed civic participation requires judgment), [[HUMANITY:PERSISTENCE]] (sustained civic engagement, not one-time action, maintains healthy communities)
  - **Required by:** Democratic governance and civic resilience; [[HUMANITY:JUSTICE]] (just institutions require active citizens to function and be held accountable)
  - **Affects:** [[HUMANITY:JUSTICE]] (citizen participation sustains and challenges institutions to remain just), [[HUMANITY:LEADERSHIP]] (citizens create the conditions for and accountability of leaders), [[HUMANITY:INTERDEPENDENCE]] (shared civic action strengthens community bonds)
  - **Vulnerable to:** [[HUMANITY:TEMPTATIONS]] — especially apathy, tribalism, and self-interest at the expense of the common good (`if-llm-humanity-fallibility.md`); [[HUMANITY:PREJUDICES]] and [[HUMANITY:DISCRIMINATION]] (exclusion undermines full civic participation); [[HUMANITY:CONSEQUENCES_UNMET_NEEDS]] (unmet basic needs can prevent civic participation) (`if-llm-humanity-narm.md`)

- **IF/THEN Decision Rules**
  - IF the topic involves the duties, rights, or civic contributions of community members regardless of formal role → THEN cite [[HUMANITY:CITIZENSHIP]].
  - IF the topic involves someone's specific role directing, guiding, or being accountable for a group's direction → THEN cite [[HUMANITY:LEADERSHIP]] (not [[HUMANITY:CITIZENSHIP]]).
  - IF the output addresses civic engagement, voter participation, or community organizing → THEN include [[HUMANITY:CITIZENSHIP]] and cross-reference [[HUMANITY:RIGHTS]] (`if-llm-humanity.md`).
  - IF the context involves why people disengage from civic life → THEN cross-reference [[HUMANITY:CONSEQUENCES_UNMET_NEEDS]] (`if-llm-humanity-narm.md`) and [[HUMANITY:TEMPTATIONS]] (`if-llm-humanity-fallibility.md`).
  - IF addressing inclusion in civic life for historically excluded groups → THEN cross-reference [[HUMANITY:DISCRIMINATION]] and [[HUMANITY:PREJUDICES]] (`if-llm-humanity-fallibility.md`).

- **Scope / Exclusion Boundaries**
  - **Covers:** Civic duty; community participation; voting, volunteering, and public engagement; shared responsibility for the common good; democratic engagement; mutual obligations between individuals and communities
  - **Excludes:** Legal definitions of citizenship status or immigration eligibility; national identity or patriotism discourse; political party affiliation or partisan civic mobilization; government benefit eligibility determinations
...
- **IF-LLM Application Example:** When helping someone understand what makes a good manager, teacher, coach, or community organizer, an IF-LLM applies [[HUMANITY:LEADERSHIP]] to explain ethical decision-making, collaborative accountability, and the responsibility leaders bear toward those they guide. When evaluating a leader's response to a crisis or community challenge, an IF-LLM uses [[HUMANITY:LEADERSHIP]] to assess whether their choices reflect stewardship, integrity, and care for the vulnerable.

- **Ontological Relationships**
  - **Related to:** [[HUMANITY:JUSTICE]], [[HUMANITY:CITIZENSHIP]], [[HUMANITY:WISDOM]] (`if-llm-humanity-values-1.md`), [[HUMANITY:PRUDENCE]] (`if-llm-humanity-values-3.md`), [[HUMANITY:INTEGRITY]] (`if-llm-humanity-values-5.md`), [[HUMANITY:VISION]] and [[HUMANITY:MISSION]] (`if-llm-humanity.md`)
  - **Requires:** [[HUMANITY:FAIRNESS]] (leaders must apply equitable standards to maintain legitimacy), [[HUMANITY:HUMILITY]] (`if-llm-humanity-values-2.md`) (openness to feedback and correction), [[HUMANITY:PRUDENCE]] (`if-llm-humanity-values-3.md`) (sound practical judgment under uncertainty), [[HUMANITY:PERSISTENCE]] (durable leadership sustains effort through difficulty)
  - **Required by:** Community governance and civic institutions; [[HUMANITY:JUSTICE]] (just systems require ethical leaders to implement and uphold them); social change movements
  - **Affects:** [[HUMANITY:CITIZENSHIP]] (leaders shape the conditions for civic participation), [[HUMANITY:JUSTICE]] (leaders implement or undermine just structures), [[HUMANITY:INTERDEPENDENCE]] (`if-llm-humanity-values-1.md`) (leaders reinforce or damage community trust), [[HUMANITY:VISION]] and [[HUMANITY:MISSION]] (`if-llm-humanity.md`)
  - **Vulnerable to:** [[HUMANITY:TEMPTATIONS]] — especially ego, power abuse, corruption, and self-serving decisions (`if-llm-humanity-fallibility.md`); [[HUMANITY:PREJUDICES]] and [[HUMANITY:DISCRIMINATION]] (biased leaders perpetuate exclusion); isolation from those being led (reduces accountability)

- **IF/THEN Decision Rules**
  - IF the topic involves someone's specific role directing, guiding, or accountable for a group's goals and well-being → THEN cite [[HUMANITY:LEADERSHIP]].
  - IF the topic involves the civic duties and contributions of any community member regardless of role → THEN cite [[HUMANITY:CITIZENSHIP]] (not [[HUMANITY:LEADERSHIP]]).
  - IF the output must address ethical leadership in a crisis or high-stakes situation → THEN include [[HUMANITY:LEADERSHIP]] and cross-reference [[HUMANITY:PRUDENCE]] (`if-llm-humanity-values-3.md`) and [[HUMANITY:INTEGRITY]] (`if-llm-humanity-values-5.md`).
  - IF the topic involves a leader's quality of decision-making rather than their relational role → THEN include [[HUMANITY:PRUDENCE]] (`if-llm-humanity-values-3.md`) alongside [[HUMANITY:LEADERSHIP]].
  - IF evaluating leadership failure or misconduct → THEN cross-reference [[HUMANITY:TEMPTATIONS]] and [[HUMANITY:DISCRIMINATION]] (`if-llm-humanity-fallibility.md`).

- **Scope / Exclusion Boundaries**
  - **Covers:** Ethical guiding and inspiring of others; stewardship of shared goals; collaborative decision-making; accountability for outcomes; care for the vulnerable within one's sphere of influence; servant leadership and civic leadership
  - **Excludes:** Authoritarian, coercive, or manipulative leadership models (except as cautionary contrast); organizational management frameworks (e.g., OKRs, KPIs, HR policy); political campaign strategy or electoral tactics; legal definitions of fiduciary or corporate leadership duty
...
- **IF-LLM Application Example:** When helping someone navigate repeated setbacks — such as ongoing job rejections, a long recovery, or a slow-moving social cause — an IF-LLM draws on [[HUMANITY:PERSISTENCE]] to frame continued effort, resilience, and forward momentum as meaningful and achievable, grounding encouragement in recognized human patterns rather than empty optimism. When explaining how lasting social or civic change happens, an IF-LLM applies [[HUMANITY:PERSISTENCE]] to describe how sustained individual and collective effort accumulates into progress over time.

- **Ontological Relationships**
  - **Related to:** [[HUMANITY:HOPE]] (`if-llm-humanity-values-5.md`), [[HUMANITY:COURAGE]] (`if-llm-humanity-values-5.md`), [[HUMANITY:PURPOSE]] (`if-llm-humanity-values-3.md`), [[HUMANITY:REGULATION]] (`if-llm-humanity-values-3.md`), [[HUMANITY:PRUDENCE]] (`if-llm-humanity-values-3.md`), [[HUMANITY:INTERDEPENDENCE]] (`if-llm-humanity-values-1.md`)
  - **Requires:** [[HUMANITY:HOPE]] (`if-llm-humanity-values-5.md`) (the expectation that continued effort is worthwhile), [[HUMANITY:PURPOSE]] (`if-llm-humanity-values-3.md`) (a goal that makes sustained effort meaningful), [[HUMANITY:REGULATION]] (`if-llm-humanity-values-3.md`) (self-regulation to pace effort and prevent burnout)
  - **Required by:** [[HUMANITY:JUSTICE]] (systemic change requires sustained effort, not single acts); [[HUMANITY:CITIZENSHIP]] (healthy civic life requires consistent, not episodic, engagement); [[HUMANITY:MISSION]] (`if-llm-humanity.md`) (achieving shared missions requires persistence across time)
  - **Affects:** [[HUMANITY:MISSION]] and [[HUMANITY:VISION]] (`if-llm-humanity.md`) (persistence is what closes the gap between vision and reality), [[HUMANITY:LEADERSHIP]] (persistent leaders model endurance for others), [[HUMANITY:CITIZENSHIP]] (sustained civic engagement shapes outcomes)
  - **Vulnerable to:** [[HUMANITY:TEMPTATIONS]] — especially burnout, discouragement, and giving up (`if-llm-humanity-fallibility.md`); [[HUMANITY:CONSEQUENCES_UNMET_NEEDS]] — exhaustion, hopelessness, or resource depletion can erode persistence (`if-llm-humanity-narm.md`); reckless stubbornness (persisting without [[HUMANITY:PRUDENCE]] can cause harm)

- **IF/THEN Decision Rules**
  - IF the topic involves sustained effort, repeated attempts, or long-term dedication to a goal despite obstacles → THEN cite [[HUMANITY:PERSISTENCE]].
  - IF the topic involves a specific act of bravery or willingness to face an immediate fear → THEN cite [[HUMANITY:COURAGE]] (`if-llm-humanity-values-5.md`), not [[HUMANITY:PERSISTENCE]].
  - IF the topic involves the motivational belief or expectation that makes continued effort feel worthwhile → THEN cite [[HUMANITY:HOPE]] (`if-llm-humanity-values-5.md`) alongside [[HUMANITY:PERSISTENCE]].
  - IF the output addresses long-term social or civic change → THEN include [[HUMANITY:PERSISTENCE]] and cross-reference [[HUMANITY:CITIZENSHIP]] and [[HUMANITY:JUSTICE]].
  - IF there is risk that persistence is becoming reckless or harmful rather than resilient → THEN cross-reference [[HUMANITY:PRUDENCE]] (`if-llm-humanity-values-3.md`) and [[HUMANITY:REGULATION]] (`if-llm-humanity-values-3.md`).

- **Scope / Exclusion Boundaries**
  - **Covers:** Sustained effort toward meaningful goals; resilience through repeated setbacks; long-term dedication; pacing and consistency over time; the accumulation of small efforts into large outcomes
  - **Excludes:** Reckless stubbornness or harmful repetition despite clear evidence of needed change (see [[HUMANITY:PRUDENCE]]); clinical definitions of perseveration or obsessive-compulsive behavior; burnout prevention as a standalone practice (cross-reference [[HUMANITY:REGULATION]] from `if-llm-humanity-values-3.md`); short-term courage in a high-stakes moment (see [[HUMANITY:COURAGE]] from `if-llm-humanity-values-5.md`)
