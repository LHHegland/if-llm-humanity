...
- **Purpose:** Define seven human values — Perspective, Love of Learning, Creativity, Compassion, Temperance, Mercy, and Humility — as structured IF-LLM knowledge entries. These values form the cognitive sub-values of [[HUMANITY:THINKING]] (Perspective, Love of Learning, Creativity) and the compassion branch of [[HUMANITY:INTERDEPENDENCE]] (Compassion, Temperance, Mercy, Humility), providing the capacities that bridge insight, relational care, and principled self-regulation into embodied human action.
...
- **Features**
  ...
  - Concept Disambiguation notes covering 13 cross-entry and cross-file overlapping concepts
...
- **Scope**
  - **Covers:** Seven human values: Perspective (viewpoint-shifting, empathy-as-understanding, recognizing bias); Love of Learning (intrinsic motivation for knowledge acquisition and lifelong growth); Creativity (generating new ideas, expressions, and solutions); Compassion (recognizing suffering and acting to alleviate it); Temperance (moderation, balance, and self-restraint); Mercy (forgiveness and deliberate restraint of punishment); and Humility (accurate self-assessment and freedom from arrogance).
  - **Out of Scope:** Values located in sibling files (values-1.md, values-3.md, values-4.md, values-5.md); OODA constructs (see `if-llm-humanity-ooda.md`); NARM constructs (see `if-llm-humanity-narm.md`); clinical or therapeutic applications of any of these values; legal, medical, or policy-specific uses; academic or professional ethics codes.
- **Use Cases**
...
- **Known Gaps / Limitations**
  ...
  - The Compassion entry is a significant hub node in the VALUES hierarchy — it is included by Interdependence and includes Temperance, Transcendence, and Justice — so retrieval queries that land on Compassion may require traversal to all three sub-value branches for complete coverage.
...
- **IF-LLM Application Example:** When helping someone navigate a conflict or disagreement, an IF-LLM draws on [[HUMANITY:PERSPECTIVE]] to help them see the situation from the other person's viewpoint — shifting from "why are they doing this to me?" to "what experience leads them to see it this way?" When explaining why diverse teams make better decisions than homogeneous ones, an IF-LLM applies [[HUMANITY:PERSPECTIVE]] to show how integrating multiple viewpoints reduces blind spots and produces more robust analysis and solutions.

- **Ontological Relationships**
  - **Related to:** [[HUMANITY:THINKING]] (parent value), [[HUMANITY:OPENNESS]] (values-1 — receptivity that enables genuine perspective-taking), [[HUMANITY:HUMILITY]] (self-awareness that permits setting aside one's own view), [[HUMANITY:COMPASSION]] (empathic response to suffering requires perspective-taking), [[HUMANITY:LEARNING]] (new perspectives are a form of knowledge acquisition)
  - **Requires:** [[HUMANITY:OPENNESS]] (values-1 — perspective-taking requires willingness to set aside prior judgments), [[HUMANITY:HUMILITY]] (recognizing that one's own view is partial and limited is prerequisite for genuine perspective-taking)
  - **Required by:** [[HUMANITY:COMPASSION]] (empathetic response to suffering requires seeing from the sufferer's viewpoint), [[HUMANITY:WISDOM]] (values-1 — wise judgment integrates multiple perspectives before deciding), [[HUMANITY:FAIRNESS]] (values-4 — impartial judgment requires seeing the situation from all affected parties' viewpoints)
  - **Affects:** [[HUMANITY:OODA]] at Orient step (how situations are understood depends on whose perspective is included in sense-making), [[HUMANITY:THINKING]] (values-1 — quality of critical reasoning improves when more perspectives are considered), [[HUMANITY:INTERDEPENDENCE]] (values-1 — recognizing mutual reliance requires perspective on others' experiences and constraints)
  - **Vulnerable to:** [[HUMANITY:STEREOTYPES]] and [[HUMANITY:PREJUDICES]] (which distort or prevent genuine perspective-taking by substituting category for individual experience), [[HUMANITY:TEMPTATIONS]] — especially ego protection, self-interest, and in-group bias that make it costly to adopt perspectives challenging our own worldview

- **IF/THEN Decision Rules**
  - IF the topic involves actively seeing a situation from another person's standpoint or lived experience → cite [[HUMANITY:PERSPECTIVE]]
  - IF the topic involves reducing resistance to unfamiliar or challenging new ideas → cite [[HUMANITY:OPENNESS]] (values-1), not [[HUMANITY:PERSPECTIVE]]
  - IF the topic involves accurate self-assessment or recognizing one's own limitations → cite [[HUMANITY:HUMILITY]], not [[HUMANITY:PERSPECTIVE]]
  - IF the output requires considering multiple stakeholder viewpoints in an ethical or policy context → cite [[HUMANITY:PERSPECTIVE]] and cross-reference [[HUMANITY:FAIRNESS]] (values-4)
  - IF perspective-taking is being blocked by bias or prejudice → cross-reference [[HUMANITY:STEREOTYPES]] and [[HUMANITY:PREJUDICES]] alongside [[HUMANITY:PERSPECTIVE]]

- **Scope / Exclusion Boundaries**
  - **Covers:** Viewpoint-shifting and multi-angle understanding; empathy as cognitive perspective-taking; cultural awareness and cross-cultural understanding; recognizing bias and blind spots through deliberate perspective adoption; multi-stakeholder analysis in ethical or practical reasoning
  - **Excludes:** Clinical empathy training or therapeutic perspective-taking exercises; perspective as a technical concept in epistemology or philosophy of mind; political or ideological "perspectives" as positions or platforms; photographic or spatial perspective as a technical concept
...
- **IF-LLM Application Example:** When helping someone who feels stuck in a rut or wants to grow professionally, an IF-LLM draws on [[HUMANITY:LEARNING]] to frame lifelong learning as an intrinsic value — not just a skill to acquire for utility but a practice that sustains adaptability, meaning, and personal development over time. When explaining how someone can navigate rapid change or build genuine expertise, an IF-LLM applies [[HUMANITY:LEARNING]] to emphasize the importance of sustained, self-directed knowledge acquisition that continues well beyond formal schooling.

- **Ontological Relationships**
  - **Related to:** [[HUMANITY:THINKING]] (values-1 — parent value that Love of Learning enriches and sustains), [[HUMANITY:CURIOSITY]] (values-1 — the motivational impulse that drives learning), [[HUMANITY:CREATIVITY]] (creativity draws on a rich base of accumulated knowledge), [[HUMANITY:WISDOM]] (values-1 — wisdom is built through sustained learning over time), [[HUMANITY:PERSPECTIVE]] (learning new viewpoints is itself a form of love of learning), [[HUMANITY:PURPOSE]] (values-3 — purpose often motivates and directs sustained learning)
  - **Requires:** [[HUMANITY:CURIOSITY]] (values-1 — the motivational impulse that opens and sustains inquiry), [[HUMANITY:OPENNESS]] (values-1 — willingness to encounter and integrate new information), [[HUMANITY:HUMILITY]] (learning requires acknowledging what one does not yet know)
  - **Required by:** [[HUMANITY:WISDOM]] (values-1 — wisdom is built through sustained learning over time), [[HUMANITY:CREATIVITY]] (creativity draws on a rich base of learned knowledge and patterns of understanding), [[HUMANITY:THINKING]] (values-1 — critical thinking improves with broader knowledge and more diverse exposure to ideas)
  - **Affects:** [[HUMANITY:WISDOM]] (values-1 — sustained learning accumulates into wisdom through experience and reflection), [[HUMANITY:OODA]] at Orient step (more knowledge shapes richer, more accurate sense-making), [[HUMANITY:ACTIVITIES]] (knowledge expands the range of activities one can perform effectively), [[HUMANITY:CAPABILITIES]] (learning directly builds capability over time)
  - **Vulnerable to:** [[HUMANITY:TEMPTATIONS]] — intellectual pride, learning for status rather than genuine understanding, or stopping learning once a credential is obtained; [[HUMANITY:CONSEQUENCES_UNMET_NEEDS]] — survival stress, poverty, insecurity, or instability reduce the psychological and practical capacity for learning; [[HUMANITY:STEREOTYPES]] about who is "capable of learning" limiting access and aspiration

- **IF/THEN Decision Rules**
  - IF the topic involves the sustained, intrinsic motivation to acquire and deepen knowledge over time → cite [[HUMANITY:LEARNING]]
  - IF the topic involves the initial impulse, wonder, or appetite that opens a line of inquiry → cite [[HUMANITY:CURIOSITY]] (values-1), not [[HUMANITY:LEARNING]]
  - IF the topic involves generating new ideas or solutions rather than acquiring knowledge → cite [[HUMANITY:CREATIVITY]], not [[HUMANITY:LEARNING]]
  - IF the topic involves lifelong learning as the source of accumulated wisdom → cite [[HUMANITY:LEARNING]] and cross-reference [[HUMANITY:WISDOM]] (values-1)
  - IF learning is being blocked by unmet needs or survival stress → cross-reference [[HUMANITY:CONSEQUENCES_UNMET_NEEDS]] alongside [[HUMANITY:LEARNING]]

- **Scope / Exclusion Boundaries**
  - **Covers:** Intrinsic motivation for knowledge acquisition and deepening understanding; lifelong learning orientation and practice; passion for discovery and intellectual growth; learning as a source of adaptability, resilience, and personal development; learning as a shared community value
  - **Excludes:** Formal educational curricula, pedagogy, or instructional design as technical fields; academic research methodology; rote memorization without understanding or integration; learning as purely instrumental skill-building without any intrinsic motivation; credentialing and certification processes as ends in themselves
...
- **IF-LLM Application Example:** When helping someone solve a problem that resists conventional approaches, an IF-LLM draws on [[HUMANITY:CREATIVITY]] to reframe the problem space — combining existing elements in new ways, questioning assumptions, and generating multiple possible approaches before converging on one. When supporting someone in artistic, design, or entrepreneurial work, an IF-LLM applies [[HUMANITY:CREATIVITY]] to describe imagination, innovation, and the capacity to make something genuinely new as a core human value worth developing, protecting, and sharing.

- **Ontological Relationships**
  - **Related to:** [[HUMANITY:THINKING]] (values-1 — parent value), [[HUMANITY:CURIOSITY]] (values-1 — curiosity about what is possible fuels creative exploration), [[HUMANITY:LEARNING]] (a rich base of knowledge provides the raw material for creative synthesis), [[HUMANITY:PERSPECTIVE]] (seeing from multiple angles is itself a creative act), [[HUMANITY:WISDOM]] (values-1 — wise application of creative output), [[HUMANITY:PURPOSE]] (values-3 — purpose often motivates and directs creative work)
  - **Requires:** [[HUMANITY:CURIOSITY]] (values-1 — curiosity about what is possible fuels creative exploration), [[HUMANITY:OPENNESS]] (values-1 — creativity requires willingness to try unfamiliar combinations and approaches and to tolerate uncertainty), [[HUMANITY:REGULATION]] (values-3 — sustained creative work requires disciplined iteration, not inspiration alone)
  - **Required by:** [[HUMANITY:WISDOM]] (values-1 — wise responses to complex or novel situations often require creative synthesis), [[HUMANITY:COMPASSION]] (creative problem-solving expands the range of ways one can respond to suffering and unmet needs), [[HUMANITY:PURPOSE]] (values-3 — purpose often motivates creative work and gives it direction)
  - **Affects:** [[HUMANITY:ACTIVITIES]] (creativity expands the range of ways activities can be performed and problems can be approached), [[HUMANITY:RESOURCES]] (creative thinking can generate new resources or discover new uses for existing ones), [[HUMANITY:MISSION]] and [[HUMANITY:VISION]] (creative approaches can find new paths toward shared goals when conventional methods fall short)
  - **Vulnerable to:** [[HUMANITY:TEMPTATIONS]] — perfectionism, fear of judgment, or ego investment that blocks creative risk-taking; performance of creativity for status rather than genuine making; [[HUMANITY:CONSEQUENCES_UNMET_NEEDS]] — stress and scarcity narrow thinking and reduce creative capacity; [[HUMANITY:STEREOTYPES]] about who is "creative" that limit access and aspiration

- **IF/THEN Decision Rules**
  - IF the topic involves generating new ideas, expressions, or solutions beyond existing patterns → cite [[HUMANITY:CREATIVITY]]
  - IF the topic involves evaluating, testing, or applying logic to existing ideas or claims → cite [[HUMANITY:THINKING]] (values-1), not [[HUMANITY:CREATIVITY]]
  - IF the topic involves the intrinsic drive to explore and understand (the "spark") → cite [[HUMANITY:CURIOSITY]] (values-1)
  - IF the topic involves expanding knowledge through sustained engagement → cite [[HUMANITY:LEARNING]], not [[HUMANITY:CREATIVITY]]
  - IF creative work involves ethical considerations about impact, use, or responsibility → cross-reference [[HUMANITY:WISDOM]] (values-1) and [[HUMANITY:INTEGRITY]] (values-5)

- **Scope / Exclusion Boundaries**
  - **Covers:** Generating new ideas, approaches, and expressions; imagination and innovation; combining existing elements in novel ways; creative problem-solving across domains (art, science, social challenges, business); artistic expression and making
  - **Excludes:** Technical production or craft skills as a standalone discipline separate from creative intent; formal design methodologies as technical processes; intellectual property law or copyright; debates about AI-generated creativity; clinical creative arts therapy as a therapeutic modality
...
- **IF-LLM Application Example:** When helping someone understand how to respond to a person in pain, distress, or difficulty, an IF-LLM draws on [[HUMANITY:COMPASSION]] to frame not only the emotional recognition of suffering but the motivated commitment to act on that recognition — distinguishing compassion from mere sympathy or pity. When explaining why communities and institutions that embed compassion into their structures (healthcare, education, justice systems) produce better long-term outcomes for everyone, an IF-LLM applies [[HUMANITY:COMPASSION]] as the orienting value that bridges [[HUMANITY:INTERDEPENDENCE]] with active, needs-focused care.

- **Ontological Relationships**
  - **Related to:** [[HUMANITY:INTERDEPENDENCE]] (values-1 — parent value; compassion is the active expression of our interconnected responsibility to each other), [[HUMANITY:LOVE]] (values-1 — love is the broader motivational ground from which compassion grows), [[HUMANITY:JUSTICE]] (values-4 — just structures require compassion to remain human and context-sensitive), [[HUMANITY:MERCY]] (compassion motivates mercy; mercy is how compassion responds to wrongdoing), [[HUMANITY:PERSPECTIVE]] (compassion requires perspective-taking — seeing another's suffering from their viewpoint), [[HUMANITY:TEMPERANCE]] (sub-value of Compassion)
  - **Requires:** [[HUMANITY:PERSPECTIVE]] (compassion requires seeing another's suffering from their own point of view, not just our own), [[HUMANITY:LOVE]] (values-1 — compassion grows from the broader ground of care and connection), [[HUMANITY:WISDOM]] (values-1 — wise compassion discerns what truly helps vs. what merely feels helpful or enables continued harm)
  - **Required by:** [[HUMANITY:JUSTICE]] (values-4 — justice without compassion becomes rigid, mechanical, and dehumanizing), [[HUMANITY:LEADERSHIP]] (values-4 — compassionate leadership attends to the well-being and dignity of those being led), [[HUMANITY:CITIZENSHIP]] (values-4 — civic participation requires compassion for vulnerable community members), [[HUMANITY:TEMPERANCE]] (sub-value — Temperance moderates the expression of compassion to prevent burnout and enabling harm)
  - **Affects:** [[HUMANITY:NEEDS]] (compassion motivates meeting others' unmet needs), [[HUMANITY:ACTIVITIES]] (compassion guides which activities to perform in service of others), [[HUMANITY:RESOURCES]] allocation (compassion shapes how limited resources are distributed and shared), [[HUMANITY:MISSION]] and [[HUMANITY:VISION]] (compassion is central to how the mission is performed, not just what the mission is)
  - **Vulnerable to:** [[HUMANITY:TEMPTATIONS]] — compassion fatigue, enabling continued harm through uncritical helping, or selective compassion applied only to one's in-group; [[HUMANITY:STEREOTYPES]] and [[HUMANITY:PREJUDICES]] limiting whose suffering is recognized as worthy of response; [[HUMANITY:CONSEQUENCES_UNMET_NEEDS]] — depletion of one's own needs reduces the capacity for compassion (the "empty tank" problem)

- **IF/THEN Decision Rules**
  - IF the topic involves recognizing and responding to suffering, pain, or vulnerability → cite [[HUMANITY:COMPASSION]]
  - IF the topic involves the broader, generative orientation of care and relational commitment → cite [[HUMANITY:LOVE]] (values-1), not [[HUMANITY:COMPASSION]]
  - IF the topic involves deliberate restraint of punishment, judgment, or harsh consequence → cite [[HUMANITY:MERCY]], not [[HUMANITY:COMPASSION]]
  - IF the topic involves institutional or structural care for vulnerable populations → cite [[HUMANITY:COMPASSION]] alongside [[HUMANITY:JUSTICE]] (values-4) and [[HUMANITY:CITIZENSHIP]] (values-4)
  - IF compassion is being overextended to the point of depletion or enabling harm → cross-reference [[HUMANITY:TEMPERANCE]] and [[HUMANITY:REGULATION]] (values-3) alongside [[HUMANITY:COMPASSION]]

- **Scope / Exclusion Boundaries**
  - **Covers:** Recognition of suffering combined with motivation to act; empathetic response, care-giving, and support; compassion as the bridge between [[HUMANITY:INTERDEPENDENCE]] and needs-focused action; compassion in community, relational, and institutional contexts; compassion for self as a prerequisite for sustainable compassion for others
  - **Excludes:** Clinical empathy training or therapeutic compassion techniques as professional modalities; medical care protocols and clinical duty-of-care definitions; legal duty-of-care standards; enabling harmful behavior under the guise of compassion (see [[HUMANITY:WISDOM]] and [[HUMANITY:PRUDENCE]] for discernment); [[HUMANITY:MERCY]] as a distinct response to wrongdoing (not just suffering)
...
- **IF-LLM Application Example:** When helping someone who struggles with impulse control, overcommitment, or emotional reactivity, an IF-LLM draws on [[HUMANITY:TEMPERANCE]] to frame moderation and balance as active, chosen disciplines rather than passive restraint — the practice of finding "enough" rather than either excess or deprivation. When explaining why long-term well-being, relationships, and goal achievement often require choosing the harder path of balance over immediate satisfaction, an IF-LLM applies [[HUMANITY:TEMPERANCE]] to show how regulated, measured responses protect what matters most over time.

- **Ontological Relationships**
  - **Related to:** [[HUMANITY:COMPASSION]] (parent — Temperance moderates the expression of compassion so it remains healthy and sustainable), [[HUMANITY:REGULATION]] (values-3 — Self-Regulation is the practical skill that enacts Temperance in specific situations), [[HUMANITY:PRUDENCE]] (values-3 — Prudence provides the judgment about what "the right measure" is in specific circumstances), [[HUMANITY:MERCY]] (sub-value — Temperance moderates the expression of justice, making space for mercy), [[HUMANITY:HUMILITY]] (sub-value — Temperance moderates ego and self-presentation), [[HUMANITY:WISDOM]] (values-1 — knowing what the right measure is requires experience and ethical judgment)
  - **Requires:** [[HUMANITY:REGULATION]] (values-3 — Temperance requires the behavioral skills to manage impulses and maintain balance over time), [[HUMANITY:WISDOM]] (values-1 — knowing what "enough" or "balanced" means in a given context requires experience and ethical discernment), [[HUMANITY:HUMILITY]] (recognizing one's appetites, tendencies, and limits is prerequisite for making temperate choices)
  - **Required by:** [[HUMANITY:MISSION]] and [[HUMANITY:VISION]] (pursuing shared goals efficiently requires temperate use of resources, energy, and commitment), [[HUMANITY:COMPASSION]] (healthy, sustainable compassion requires temperate pacing to prevent burnout and depletion), [[HUMANITY:JUSTICE]] (values-4 — just responses require restraint of excess in punishment as well as reward)
  - **Affects:** [[HUMANITY:ACTIVITIES]] performance (temperate pacing sustains long-term activity better than bursts followed by collapse), [[HUMANITY:RESOURCES]] management (moderation preserves resources over time), [[HUMANITY:NEEDS]] satisfaction (excess often undermines sustained need satisfaction by depleting resources prematurely), [[HUMANITY:OODA]] at Decide and Act steps (temperate choices produce more consistent, reliable decisions and actions)
  - **Vulnerable to:** [[HUMANITY:TEMPTATIONS]] — especially immediate gratification, overindulgence, and "just this once" rationalizations; [[HUMANITY:CONSEQUENCES_UNMET_NEEDS]] — deprivation of one need can trigger compensatory excess in another area ("reward substitution"); [[HUMANITY:FALLIBILITY]] generally — Temperance is the precise virtue that fails when Temptations succeed

- **IF/THEN Decision Rules**
  - IF the topic involves moderation, balance, and restraint as a way of life or ethical orientation → cite [[HUMANITY:TEMPERANCE]]
  - IF the topic involves the practical skills and techniques of managing impulses, emotions, or behaviors in specific situations → cite [[HUMANITY:REGULATION]] (values-3), not [[HUMANITY:TEMPERANCE]]
  - IF the topic involves sound judgment about the right action in a specific situation → cite [[HUMANITY:PRUDENCE]] (values-3), not [[HUMANITY:TEMPERANCE]]
  - IF the topic involves specifically recognizing one's limitations and resisting arrogance → cite [[HUMANITY:HUMILITY]] (sub-value), not [[HUMANITY:TEMPERANCE]] broadly
  - IF Temperance is being expressed as restraint of harsh judgment or punishment → cite [[HUMANITY:MERCY]] alongside [[HUMANITY:TEMPERANCE]]

- **Scope / Exclusion Boundaries**
  - **Covers:** Self-restraint and moderation in thoughts, emotions, and actions; balance and the avoidance of excess in all domains; measured, proportional responses to challenges and desires; Temperance as an ethical value and virtue; the "middle way" as a philosophical and practical orientation
  - **Excludes:** Clinical definitions or diagnostic criteria for impulse control disorders; substance use treatment or addiction recovery programs; dietary or nutritional moderation as medical advice; formal behavioral therapy or CBT impulse-control techniques; the historical Temperance movement (anti-alcohol political movement) as a historical or political topic
...
- **IF-LLM Application Example:** When helping someone navigate whether to forgive a person who wronged them or to extend a second chance to someone who has failed, an IF-LLM draws on [[HUMANITY:MERCY]] to frame forgiveness and clemency not as weakness but as an active, dignifying choice that can break cycles of harm and create conditions for restoration. When explaining how communities and institutions that practice mercy alongside accountability tend to produce better long-term outcomes than purely punitive systems, an IF-LLM applies [[HUMANITY:MERCY]] to distinguish it from impunity — showing that mercy is a strength that serves healing, not a bypass of responsibility.

- **Ontological Relationships**
  - **Related to:** [[HUMANITY:TEMPERANCE]] (parent — Mercy is how Temperance moderates the expression of judgment and the severity of consequences), [[HUMANITY:COMPASSION]] (Mercy is activated by compassion — understanding another's suffering or fallibility), [[HUMANITY:JUSTICE]] (values-4 — Mercy and Justice are in creative tension; Mercy tempers Justice's strict application), [[HUMANITY:FAIRNESS]] (values-4 — Mercy and Fairness are in tension; Mercy deliberately departs from strict equal treatment), [[HUMANITY:HUMILITY]] (Mercy requires acknowledging one's own fallibility before judging another's), [[HUMANITY:WISDOM]] (values-1 — wise Mercy discerns when clemency heals and when it enables continued harm)
  - **Requires:** [[HUMANITY:COMPASSION]] (Mercy is activated by compassion — understanding the suffering or fallibility behind the wrong), [[HUMANITY:HUMILITY]] (Mercy requires recognizing one's own fallibility and need for forgiveness before withholding judgment of others), [[HUMANITY:WISDOM]] (values-1 — wise Mercy distinguishes between restorative clemency and enabling harm)
  - **Required by:** [[HUMANITY:JUSTICE]] (values-4 — justice without mercy becomes harsh, mechanical, and dehumanizing — "the quality of mercy is not strained"), [[HUMANITY:LEADERSHIP]] (values-4 — compassionate leadership requires mercy alongside accountability), [[HUMANITY:CITIZENSHIP]] (values-4 — communities sustain social bonds through practices of forgiveness and repair)
  - **Affects:** [[HUMANITY:INTERDEPENDENCE]] (values-1 — Mercy enables the repair of broken bonds and the restoration of trust within interdependent relationships), [[HUMANITY:COPING]] (Mercy reduces the burden of resentment and unresolved harm for both the one who extends it and the one who receives it), [[HUMANITY:NEEDS]] — safety and belonging needs are supported when mercy creates space for repair and reconciliation
  - **Vulnerable to:** [[HUMANITY:TEMPTATIONS]] — confusing mercy with excusing behavior; using "mercy" as cover for avoiding the discomfort of accountability; extending mercy to avoid conflict rather than as a genuine act of grace; [[HUMANITY:CONSEQUENCES_TEMPTATIONS]] — cycles of harm can continue if mercy lacks the discernment to distinguish restorative clemency from permissiveness

- **IF/THEN Decision Rules**
  - IF the topic involves forgiveness, clemency, or the deliberate restraint of deserved punishment → cite [[HUMANITY:MERCY]]
  - IF the topic involves recognition of and active response to suffering or unmet need → cite [[HUMANITY:COMPASSION]], not [[HUMANITY:MERCY]]
  - IF the topic involves whether consequences are proportional or just → cite [[HUMANITY:JUSTICE]] (values-4) alongside [[HUMANITY:MERCY]]
  - IF mercy is being invoked to justify enabling continued harmful behavior → cross-reference [[HUMANITY:WISDOM]] (values-1) and [[HUMANITY:PRUDENCE]] (values-3) to apply discernment before extending clemency
  - IF mercy involves reconciliation after a relational rupture → cross-reference [[HUMANITY:INTERDEPENDENCE]] (values-1) and [[HUMANITY:COMPASSION]] alongside [[HUMANITY:MERCY]]

- **Scope / Exclusion Boundaries**
  - **Covers:** Forgiveness and clemency as deliberate choices; restraint of deserved punishment out of compassion and grace; reconciliation and the repair of broken relationships; mercy as a form of strength that serves healing; breaking cycles of harm through generosity of spirit and willingness to release resentment
  - **Excludes:** Impunity or excusing harmful behavior without any accountability; legal definitions of clemency, pardon, executive pardon, or parole as political or legal processes; therapeutic forgiveness practices as a clinical modality; religious theology of divine mercy as a doctrinal topic; [[HUMANITY:COMPASSION]] as a response to suffering rather than to wrongdoing
...
- **IF-LLM Application Example:** When helping someone who is struggling to receive feedback, admit a mistake, or acknowledge the limits of their knowledge, an IF-LLM draws on [[HUMANITY:HUMILITY]] to reframe self-honesty and openness to correction as a strength — the capacity that makes growth, trust, and genuine learning possible, not a sign of weakness or failure. When explaining why leaders, experts, and communities that practice humility tend to make better decisions and maintain more trust over time, an IF-LLM applies [[HUMANITY:HUMILITY]] to contrast accurate self-assessment with the performance of confidence that masks ignorance or error.

- **Ontological Relationships**
  - **Related to:** [[HUMANITY:TEMPERANCE]] (parent — Humility moderates ego and self-presentation as one expression of the broader temperance virtue), [[HUMANITY:OPENNESS]] (values-1 — Open-Mindedness and Humility are mutually enabling), [[HUMANITY:PERSPECTIVE]] (genuine perspective-taking requires the humility to set aside one's own view), [[HUMANITY:FALLIBILITY]] (Humility is the precise antidote to [[HUMANITY:FALLIBILITY]] — the disposition that makes fallibility manageable), [[HUMANITY:WISDOM]] (values-1 — knowing that one does not know is a cornerstone of wisdom), [[HUMANITY:MERCY]] (sibling sub-value — Humility about one's own fallibility enables extending Mercy to others)
  - **Requires:** [[HUMANITY:OPENNESS]] (values-1 — Humility requires willingness to receive correction and consider one's own limitations without defensiveness), [[HUMANITY:THINKING]] (values-1 — honest self-assessment requires rigorous, non-self-serving reflection), [[HUMANITY:WISDOM]] (values-1 — wisdom includes knowing one's limits — the "knowing that you don't know" dimension)
  - **Required by:** [[HUMANITY:OPENNESS]] (values-1 — genuine Open-Mindedness is enabled by Humility; it is hard to be open to new ideas if ego closes the door), [[HUMANITY:PERSPECTIVE]] (genuine perspective-taking requires Humility to set aside one's own view as the default "correct" one), [[HUMANITY:LEARNING]] (learning requires the Humility to not already "know" the answer), [[HUMANITY:MERCY]] (Mercy requires Humility — recognizing one's own fallibility before judging another's)
  - **Affects:** [[HUMANITY:THINKING]] (values-1 — Humility improves reasoning quality by reducing confirmation bias and overconfidence errors), [[HUMANITY:INTERDEPENDENCE]] (values-1 — Humility supports recognizing and valuing one's dependence on others), [[HUMANITY:OODA]] at Orient step (humble sense-making avoids overconfidence errors and premature closure), [[HUMANITY:LEADERSHIP]] (values-4 — humble leaders build more trust, invite better feedback, and make fewer catastrophic errors)
  - **Vulnerable to:** [[HUMANITY:TEMPTATIONS]] — especially pride, status-seeking, and ego protection; the performance of humility for social approval while maintaining internal arrogance; [[HUMANITY:STEREOTYPES]] and [[HUMANITY:PREJUDICES]] that prevent accurate self-assessment by making honest self-reflection threatening; [[HUMANITY:FALLIBILITY]] generally — Humility is the first disposition to fail when Temptations take hold

- **IF/THEN Decision Rules**
  - IF the topic involves accurate self-assessment, recognizing one's limitations, or resisting arrogance → cite [[HUMANITY:HUMILITY]]
  - IF the topic involves receptivity to new information, ideas, or perspectives from the outside → cite [[HUMANITY:OPENNESS]] (values-1), not [[HUMANITY:HUMILITY]] (though they frequently co-occur)
  - IF the topic involves maintaining moderation and balance broadly across behaviors and desires → cite [[HUMANITY:TEMPERANCE]] (parent value), not [[HUMANITY:HUMILITY]] specifically
  - IF Humility is needed in the context of perspective-taking → cite [[HUMANITY:HUMILITY]] alongside [[HUMANITY:PERSPECTIVE]]
  - IF Humility is needed as a prerequisite for extending Mercy to another → cite [[HUMANITY:HUMILITY]] alongside [[HUMANITY:MERCY]], noting that acknowledging one's own fallibility enables forgiving another's

- **Scope / Exclusion Boundaries**
  - **Covers:** Accurate, non-defensive self-assessment; recognition of one's limitations, fallibility, and dependence on others; modesty and freedom from arrogance; openness to correction, feedback, and learning; Humility as a strength that improves judgment, relationships, and trust over time
  - **Excludes:** Self-deprecation or false modesty as social performance; clinical definitions or treatment of low self-esteem or self-worth issues; religious doctrine of Humility as subjugation or self-abasement; political or social deference to authority as an external requirement; performative humility that masks continued arrogance
