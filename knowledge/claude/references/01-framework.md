---
name: Humanity Wisdom — Root Framework
source: humanity.md (original)
---

## Plain-English Summary

This is the foundation of the whole system. It describes what humanity is
striving toward (the Vision), how each of us can contribute day to day (the
Mission), and what every person deserves simply by being human (Unalienable
Rights). It also lists the biggest concerns people face across history — from
economic hardship to social division to climate — and the most important lessons
humanity has learned over time. Finally, it covers Coping: practical things that
help when life is very hard, including crisis hotlines, community resources, and
everyday habits backed by research.

Read this file when someone is overwhelmed or in distress, wants to understand
common human challenges, is asking what history teaches, or needs a grounding in
humanity's shared purpose.

**Navigation note:** Skip past the "File Header" section below (legacy metadata
with TBD placeholders and stale file references to old GPT filenames — ignore
those). The active cross-reference index is `00-index.md`. Jump directly to
content at `## Humanity` (approx. line 75).
...
- **Name**: GPT RBI Humanity
- **Version**: 2026-01-31 06:03 UTC by LHH
- **Purpose**: The shared goal of these knowledge files is to help an average adult in the U.S. today to think more clearly, calmly, and fairly about real-life situations—especially under uncertainty—without turning ChatGPT into a medical, legal, or moral authority. These use cases emphasize sensemaking, decision hygiene, and human dignity, while respecting autonomy and professional boundaries.
- **Audience**: Average, diverse people in the United States of America today.
- **Supplemental Files**: Use with the following supplemental files to include knowledge subdomains mapped to the following common human topic references and canonical handles (i.e., IDs and namespaced tags): 
  - 'GPT RBI Humanity Experts 202601310149.md' → Experts → HUMANITY.ELEMENTS.EXPERTS → [[HUMANITY:EXPERTS]]
  - 'GPT RBI Humanity OODA 202601310146.md' → Processing (OODA: Observe → Orient → Decide →  Act) → HUMANITY.ELEMENTS.OODA → [[HUMANITY:OODA]]
- **Features**
...
- **Scope**
  ...
  - High-stakes situations still defer to professionals (per Rules)
- **Use Cases**
  - **Supported**:
...
See `00-index.md` for the complete cross-reference map of all concepts and canonical tags across all files in this skill.
...
- Self-Help Options
  ...
  - Five Quick and Easy Daily Habits (Source: [The Happiness Advantage: How a Positive Brain Fuels Success in Work and Life](https://www.amazon.com/Happiness-Advantage-Principles-Psychology-Performance/dp/0307591549) written by Shawn Achor and published by Crown Currency during 2010)
...
Common concerns of humanity observed across our many, diverse communities throughout our history along with relatable modern societal examples, not exhaustive; use examples when the user’s request is about modern societal concerns.
- Economic Concerns
  - Cost of Living
...
Humanity’s most significant lessons learned that have been gathered, tested, refined, and shared throughout human history across our many diverse communities and societies — our [[HUMANITY:WISDOM]].
- Adaptability
...
- Interdependence
  - No human survives or thrives alone; cooperation is essential.
  - Societies progress through collaboration, shared resources, and knowledge exchange.
...
- Wisdom Through Storytelling and Tradition
...
- Balance of Change and Stability
  - Societies evolve, but core human values remain constant.
  - Innovation thrives when grounded in foundational wisdom.
...
Equal opportunity to satisfy [[HUMANITY:NEEDS]].
...
Each and every person, living being, and part of our environment has [[HUMANITY:RIGHTS]], both now and throughout the future.
...
Simply do our best in each moment to practice our [[HUMANITY:WISDOM]], honor our [[HUMANITY:INTERDEPENDENCE]], plus show [[HUMANITY:COMPASSION]] and [[HUMANITY:PERSISTENCE]] for others and ourselves given our unique circumstances and our [[HUMANITY:RESOURCES]].