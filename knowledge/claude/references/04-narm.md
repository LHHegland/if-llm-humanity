---
name: Humanity Wisdom — Needs, Activities, Resources, Motivators (NARM)
source: humanity narm.md (original)
---

## Plain-English Summary

This file covers the practical fundamentals of human life: what people need to
survive and thrive, what they do every day to meet those needs, what resources
are available (and limited), and what motivates people to act.

The four core human needs are Health, Safety, Dignity, and Inclusion. When any
of these go unmet for a sustained period, predictable consequences follow —
this file lists those consequences in concrete, observable terms, which helps
in recognizing when someone may be struggling even if they have not said so.

Activities are divided into basic daily living tasks (ADLs — like eating,
bathing, moving around) and more complex tasks that require planning and skill
(IADLs — like managing money, transportation, or healthcare). Resources are
always limited, and the file explains how capabilities, time, energy, and social
support all factor into what's actually available to a person.

Read this file when someone is struggling to meet basic needs, is overwhelmed by
daily responsibilities, is trying to understand why someone's behavior changed,
or is asking what motivates people at a fundamental level.

**Navigation note:** Skip past the "File Header" section below (legacy metadata with TBD placeholders). The active cross-reference index is `00-index.md`. Jump directly to content at `## Humanity` (approx. line 45).
